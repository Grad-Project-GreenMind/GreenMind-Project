      ...
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-start gap-16">
        ...
        <div className="flex-1 max-w-[200px] text-left">
          ...
          <ul className="space-y-4 text-[18px] font-normal list-none p-0 m-0">
            <li><Link to="/" className={getLinkStyle('/')}>Home</Link></li>
            <li><Link to="/articles" className={getLinkStyle('/articles')}>Articles</Link></li>
            <li><Link to="/#why-us" className={getLinkStyle('/#why-us')}>Why Us</Link></li>
            <li><Link to="/#features" className={getLinkStyle('/#features')}>Features</Link></li>
            <li><Link to="/#products" className={getLinkStyle('/#products')}>Products</Link></li>
            <li><Link to="/#faq" className={getLinkStyle('/#faq')}>FAQ</Link></li>           
          </ul>
        </div>
        ...
        <div className="flex-1 max-w-[300px] text-left">
          ...
          <div className="space-y-5 text-[#4B4B4B] text-[18px] font-normal">
            <a href="tel:+201023456789" className="block no-underline hover:text-[#4CAF50] transition-colors">
              +201023456789
            </a>
            
            <a href="mailto:support@GreenMind.com" className="block no-underline hover:text-[#4CAF50] transition-colors">
